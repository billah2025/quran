        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                <h1 className="text-3xl font-bold mb-6 text-center">
                    {selectedSection === 3 ? 'পরীক্ষা' : selectedSection === 2 ? 'পরীক্ষা' : 'তাজবিদ পরিচিতি '}
                </h1>
                ...
                {selectedSection === 2 && (
                    <div className="py-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
                            {/* Card 1 */}
                            <Link href="/learnquran/quize/tajweed2" passHref>
                                <div
...
<div className="relative w-[100%] sm:w-[100%]  md:w-[100%] lg:w-[75%] xl:w-[75%] mx-auto mt-[5%] mb-[2%]">
  {/* Image */}
  <Image
    src="/svg/tajweed/signs.svg"
    alt="Maad Part 2"
    width={0}
    height={0}
    sizes="100vw"
