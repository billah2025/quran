    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full px-8 max-w-6xl pb-24">
                {[
                    { name: "তাজবীদ পর্ব ১", icon: "1️⃣", link: "/learnquran/tajbid/tajbid1" },
                    { name: "তাজবীদ পর্ব ২ ", icon: "2️⃣", link: "/learnquran/tajbid/tajbid2" },
                    { name: "চিনহ সমূহ  ", icon: "3️⃣", link: "/learnquran/tajbid/tajbid3" },
                ].map((lesson, index) => (
