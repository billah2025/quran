...
const questions = [
    {
        id: 1, audio: "/audio/quizes/inne.mp3", options: ["اَنَّ",
            "اَنِّ",
            "اِنِّ",
            "اِنَّ"], answer: "اِنِّ"
    },
    {
        id: 2, audio: "/audio/quizes/kajjabu.mp3", options: ["کِذَّبَوْ",
            "کَذَّبَوْ",
            "کَذِّبُوْ",
            "کَذَّبُوْ"], answer: "کَذَّبُوْ"
    },
    {
        id: 3, audio: "/audio/quizes/raibimmimma.mp3", options: ["رَیۡبٍ مَّمَّا",
            "رَیۡبٍ مِّمَّا",
            "رَیۡبٍ مِّمِّا",
            "رَیۡبٍ مِّا"], answer: "رَیۡبٍ مِّمَّا"
    },
    {
        id: 4, audio: "/audio/quizes/jurreitaha.mp3", options: ["ذُرِّیَّتَہَا",
            "ذُرَّیَّتَہَا",
            "ذُرِّیَّتَہُا",
            "ذُرِیَّتَہا"], answer: "ذُرِّیَّتَہَا"
    },
    {
        id: 5, audio: "/audio/quizes/ashshahidina.mp3", options: ["الشَّہَدِیْنَ",
            "الشَّہِدُیْنَ",
            "الشّٰہِدِیْنَ",
            " الشِّہِدِیْنَ"], answer: "الشّٰہِدِیْنَ"
    },
...
const finishExam = useCallback(() => {
    ...
    // Save quiz summary with a unique ID (e.g., "quiz-tashdid")
    const quizId = "tashdid"; // Replace with dynamic quiz ID if needed
...
useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-600 to-purple-800 text-white relative p-4">
            {/* Header */}
            <h1 className="text-2xl font-bold text-center m-8 ">📝তাশদীদ পরিচিতি</h1>
