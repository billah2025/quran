...
const finishExam = useCallback(() => {
  ...
  // Save quiz summary with a unique ID (e.g., "quiz-harkatquiz")
  const quizId = "harkatquiz"; // Replace with dynamic quiz ID if needed
...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 to-purple-800 text-white relative p-4">
      <h1 className="text-2xl font-bold text-center m-8">📝 হারকাত ও তানবীন পরিচিতি</h1>
