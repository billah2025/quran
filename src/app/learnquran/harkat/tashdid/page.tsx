...
const letters: LetterData[] = [
    ...
    { letter:"اَمَّ", bangla: '', audio: '/audio/tashdid/amma.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
    { letter:"اَبَّ", bangla: '', audio: '/audio/tashdid/abba.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
    { letter:"اَلَّذِ", bangla: '', audio: '/audio/tashdid/allaji.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
    { letter: "اٰمَنَّا", bangla: '', audio: '/audio/tashdid/amanna.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
    { letter: "اَللّٰہُ", bangla: '', audio: '/audio/tashdid/allahu.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
    { letter: "اِنَّ الَّذِ", bangla: '', audio: '/audio/tashdid/innallaji.mp3', tajweed: '', usageTypes: [], imageSection1: '', imageSection2: '' },
        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                <h1 className="text-3xl font-bold mb-6 text-center">
                    {selectedSection === 3 ? 'পরীক্ষা' : selectedSection === 2 ? ' তাশদীদ যুক্ত শব্দের উচ্চারণ  ' : '   তাশদীদ পরিচিতি '}
                </h1>
                ...
                {selectedSection === 3 && (
                    <div className="py-8">
                        ...
                        >
                         তাশদীদ পরিচিতি পরীক্ষা 🏆
                        </h2>

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
                            {/* Card 1 */}
                            <Link href="/learnquran/quize/harkat/tashdid" passHref>
                                <div
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <h3 className="text-xl font-bold mb-2">1️⃣    তাশদীদ পরিচিতি পরিক্ষা </h3>
                ...
                {selectedSection === 1 && (
                    <div className='text-left' >
                        ...
                        <Image
                            src="/svg/tashdid/tashdid_part1.svg"
                            alt="Letter visual"
                        ...
                        />
                        <Image
                            src="/svg/tashdid/tashdid_part2.svg"
                            alt="Letter visual"
                            className="mx-auto object-contain rounded-lg border"
                            layout="responsive" // Makes the image responsive
                            width={100} // These act as aspect ratio dimensions
